...
namespace BurnMedia
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            //GetNextDownloadedFiles();
        }

        private string GetNextDownloadedFiles()
        {

            //var downloader = new DicomDownloader();
            //var fileRootPath = downloader.DoProcess();
            //var prep = new BurnerPreparation();
            //var folderPath = prep.DoProcess();

            //if (!string.IsNullOrEmpty(folderPath))
            //{
            //    AddFilesToList(folderPath);
            //}
        ...
        private void buttonBurn_Click(object sender, EventArgs e)
        {
            ...
            FormatStart();
            //var burner = new BurnerPreparation();
            //var burnJobRootPath = burner.DoProcess();
            //var burnDetailModel = burner.LastBurnDetail;

            //if (burnJobRootPath != null)
            //{
            //    //var burnJobRootPath = string.Empty;
            //    StartBurning(burnJobRootPath);
            //    burnDetailModel.BurnJob.Status = BurnStatus.Completed;
            //    CommonServices.ChangeBurnStatus(burnDetailModel.BurnJob);
            //}
        ...
        void AddFilesToList(string fileRootPath)
        {
            CreateDirFile(fileRootPath);

            listBoxFiles.Items.Clear();

            var dItem = new DirectoryItem(fileRootPath);
            listBoxFiles.Items.Add(dItem);



            //var files = Directory.GetFiles(fileRootPath);
            ...
            {
                var directoryItem = new DirectoryItem(dc);
        ...
        private void PrepareAdditionalSetupFiles()
        {
        ...
        private void FormatStart()
        {

            this.formatProgressBar.Show();
        ...
        private void refreashBurnFiles()
        {
            this.formatProgressBar.Hide();
